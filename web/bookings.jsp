	...
	<div class="res">
		<form>
			<table>
				...
				<tr>
					<td>Date Of Birth:</td>
					<td><input class="border" name="date" type="date" id="datePicker"/></td>
				</tr>
				<tr>
					<td>Gender:</td>
				...
				<tr>
					<td>Contact No:</td>
					<td><input type="text" name="contactno" class="border"  /></td>
				</tr>
				<tr>
					<td>Class:</td>
					<td>
				...
				<tr>
					<td colspan=2><a href="#" style="float:left;"class="button2">BOOK NOW</a></td>
				</tr>
			</table>
		</form>
	</div>
